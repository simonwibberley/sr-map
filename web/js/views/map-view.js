        ...
        render: function() {
            ...
            var makeTimeline = (features) => {
                var timeline = L.timeline(features, {
                    ...
                    getInterval: (feature) => {
                        return {
                            start : moment(feature.properties.start).toDate(),//.subtract(4, 'months').toDate(),
                            end : moment(feature.properties.end).toDate()//.add(4, 'months').toDate(),
                        };
                    },
                    // drawOnSetTime: false,
            ...
            // control.addTo(map);
						...
						var makeLegend = function( ) {
							var legendData = [{
									...
									'description': 'Covers letters and listings relating to personal finance (including tax affairs, pensions and benefits), activist businesses (including booksellers, therapists, feminist merchandise, collectives and cooperatives) and sources of support for feminist ventures (e.g. Spare Rib revenue, sources of funding for women’s centres). Consists mainly of listings advertising small businesses, demonstrating the existence and wide geographical distribution of a feminist economic base.'
								},{
									...
									'description': 'Covers listings and letters related to schools, educational courses, universities, training and workshops, as well as broadly intellectual and research-related listings and letters including talks, seminars, classes, research projects and courses.'
								},{
									'category': 'Events & Meetings',
									'description': 'Covers both political events and recreational: political conferences, demonstrations and marches, fairs and festivals, and smaller meetings (these could range from Spare Rib reader meetings to local campaign group meetings to discuss a local or ideological issue, or tomobilise). Educational talks, workshops, seminars and courses are categorized under \'Education, Training & Research\', and art exhibitions and concerts under \'Arts & Culture\'.'
								},{
									'category': 'Groups, Networks & Centres',
									'description': 'Covers consciousness raising groups (a substantial section in the listings, in which women either sought members for existing groups, sought information on local groups they could join, or sought co-founders for a new group); networks (Spare Rib readers and reader-activists worked through, or set up, a wide range of networks designed for collective action or for support, particularly in professional and health-related domains); and women’s centres (Spare Ribwas a crucial forum for movement news, including the announcement of new centres, and updates and calls for help and support with existing/flailing ones).'
								},{
									'category': 'Health, Sex & Therapy',
									'description': "Indicates listings and letters related to women's physical wellbeing and issues of mental health, as well as a wide range of material relating to sexual experience, reproductive healthand physical and psychological self-exploration. Spare Rib saw a growing commercial offering of therapists and therapeutic services advertising in the listings, but also more therapy and mental-health-oriented grass roots support meetings, activity and research. The section also includes self-development – assertiveness training, astrology, tarot readings and meditation."
								},{
									...
									'description': 'Comprised largely of personal adverts/lonely hearts (largely lesbian) in the listings section and letters on the topic of marriage, friendships, and romance, but also entries that concern motherhood, parenting and familial issues.'
								},{
									'category': 'SR',
					    ...
					    map.addControl(legend)
							...
							map.on("zoomstart", function(e) {
									var header = $(".leaflet-html-legend h4");
