            ...
            // control.addTo(map);
						...
						var makeLegend = function( ) {
							var legendData = [{
									...
									'description': 'Covers both political events and recreational: political conferences, demonstrations and marches, fairs and festivals, and smaller meetings (these could range from Spare Rib reader meetings to local campaign group meetings to discuss a local or ideological issue, or to mobilise). Educational talks, workshops, seminars and courses are categorized under \'Education, Training & Research\', and art exhibitions and concerts under \'Arts & Culture\'.'
								},{
