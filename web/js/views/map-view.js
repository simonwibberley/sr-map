            ...
            letterListingFilter.enableMCG(clusterLayer);
						...
						var searchControl = new L.Control.Search({
							...
							filterData: function(text, records) {
								...
								for(var i in jsons) {
									key = jsons[i].item.properties.data.str_id;
									if(key in records) {
										ret[ key ]= records[key];
									}
								}
            ...
            // control.addTo(map);
						...
						var makeLegend = function( ) {
							var legendData = [{
									...
									'description': 'Covers listings and letters related to schools, educational courses,universities,training and workshops, as well as broadly intellectual and research-related listings and letters includingtalks, seminars, classes,research projects and courses.'
								},{
									'category': 'Events & Meetings',
									'description': 'Coversboth political events and recreational: political conferences, demonstrations and marches, fairs and festivals, and smaller meetings (these could range from Spare Ribreader meetings to local campaign group meetingsto discuss a local or ideological issue, or tomobilise). Educational talks, workshops, seminars and courses are categorized under \'Education, Training & Research\', and art exhibitions and concerts under \'Arts & Culture\'.'
								},{
									'category': 'Groups, Networks & Centres',
									'description': 'Covers consciousness raisinggroups(a substantial section in the listings, in which women either sought members for existing groups, sought information on local groups they could join, or sought co-founders for a new group);networks(Spare Ribreaders and reader-activists worked through, or set up, a wide range of networks designedfor collective action or for support, particularly in professional and health-related domains); andwomen’s centres(Spare Ribwas a crucial forum for movement news, including the announcement of newcentres, and updates and calls for help and support with existing/flailing ones).'
								},{
									'category': 'Health, Sex & Therapy',
									'description': "Indicates listings and letters related to women's physical wellbeing and issues of mental health, as well as a wide range of material relating tosexual experience, reproductive healthand physical and psychological self-exploration.Spare Rib saw a growing commercial offering of therapists and therapeutic services advertising in the listings, but also more therapy and mental-health-oriented grassroots support meetings, activity and research. The section also includes self-development – assertiveness training, astrology, tarotreadings and meditation."
								},{
									'category': 'Housing & Accommodation',
									'description': 'Largely based on listings from women advertisingfor lodgers or(often communal) living arrangements and those seeking the same. This section also covers letters or listings that address the politics of housing, but not holiday homes.'
								},{
									...
									'description': 'Comprised largely ofpersonal adverts/lonely hearts(largely lesbian) in the listings section and letters on the topic of marriage, friendships, and romance, but also entries that concern motherhood, parenting and familial issues.'
								},{
									'category': 'SR',
									...
									'description': "Letters and listings related to the Women's Liberation Movement (its development, perceived problems, strengths and suggested areas of improvement), campaigns conducted under its aegis(from abortion to health to employment), and to related social movements."
								},{
									'category': 'Work',
									'description': 'Letters and listings related to workplace experience, recruitment, volunteering, labourconditions and trade unions. There is some overlap with the ‘Business and Finance’ category as feminist businesses frequently advertise in Spare Rib, but a large proportion of job advertisements are in the public sector (social work, local government).'
								}
							];
